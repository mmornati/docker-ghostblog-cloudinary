...
FROM mmornati/docker-ghostblog:1.12.0
LABEL maintainer="Marco Mornati <marco@mornati.net>"

#Install Cloudinary Store into the internal modules
COPY --from=plugin-builder /builder/cloudinary-store /ghost/blog/versions/1.12.0/core/server/adapters/storage/cloudinary-store
